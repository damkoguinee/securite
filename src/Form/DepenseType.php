    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
            ...
            ->add('dateOperation', DateTimeType::class, [
                ...
                'widget' => 'single_text',
                'required' => true,
                'data' => $depense->getId() ? $depense->getDateOperation() : new \DateTime(), // Définir la date et l'heure par défaut sur la date et l'heure actuelles
                'attr' => [
